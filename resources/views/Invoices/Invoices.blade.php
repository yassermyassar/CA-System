...
@endsection
@section('content')
    @if (session()->has('updateState'))
        <div class="alert alert-success alert-dismissible fade show" role="alert">
            <strong>{{ session()->get('updateState') }}</strong>
        ...
        <div class="col-xl-12">
            <div class="card mg-b-20">
                <div class="card-header pb-0">
                    ...
                    <a class="modal-effect btn btn-outline-primary" data-effect="effect-scale"
                        href="{{ route('exportInvoices') }}">تصدير اكسيل </a>
                </div>
                <div class="card-body">
                            ...
                            <tbody>
                                ...
                                @foreach ($invoice as $x)
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $x->Amount_collection }}</td>
                                        <td>{{ $x->Amount_Commission }}</td>
                                        <td>{{ $x->Discount }}</td>
                                        <td>{{ $x->Total }}</td>
                                        <td>
                                            @if ($x->Value_Status == 1)
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu tx-13">
                                                    <a class="dropdown-item"
                                                        href="{{ url('edit_invoice') }}/{{ $x->id }}">
                                                        تعديل</a>
                                                    <a class="dropdown-item" href="#"
                                                        data-invoice_id="{{ $x->id }}" data-toggle="modal"
