...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="left-content">
            <div>
                <h2 class="main-content-title tx-24 mg-b-1 mg-b-lg-1">مرحبا بك مرة أخرى</h2>
                <p class="mg-b-0">سي اي - ادارة الفواتير</p>
            </div>
        </div>
                    ...
                    <div class="pb-0 mt-0">
                        <div class="d-flex">
                            <div class="">
                                ...
                                <h5 class="mb-0 tx-12 text-white op-7"> اجمالي عدد الفواتير
                    ...
                    <div class="pb-0 mt-0">
                        <div class="d-flex">
                            <div class="">
                                ...
                                <h5 class="mb-0 tx-12 text-white op-7"> عدد الفواتير المدفوعة
                    ...
                    <div class="pb-0 mt-0">
                        <div class="d-flex">
                            <div class="">
                                ...
                                <h5 class="mb-0 tx-12 text-white op-7">عدد الفواتير المدفوعة جزئيا
            ...
            <div class="card">
                <div class="card-header bg-transparent pd-b-0 pd-t-20 bd-b-0">
                    <div class="d-flex justify-content-between">
                        <h4 class="card-title mb-0">الحالة البيانية للفواتير </h4>
                        <i class="mdi mdi-dots-horizontal text-gray"></i>
                    </div>

                </div>
                <div style="width:70%; height: 440px; !important ">
...
@section('js')
    ...
    <script src5 5="{{ URL::asset('assets/js/jquery.vmap.sampledata.js') }}"></script>
