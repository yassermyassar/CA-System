...
<aside class="app-sidebar sidebar-scroll">
    <div class="main-sidebar-header active">
        ...
        <a class="logo-icon mobile-logo icon-light active" href="{{ url('/' . ($page = 'index')) }}"><img
                src="{{ URL::asset('assets/img/brand/last.jpg') }}" class="logo-icon" alt="logo"></a>
            ...
            <div class="dropdown user-pro-body">
                <div class="">
                    <img alt="user-img" class="avatar avatar-xl brround"
                        src="{{ URL::asset('assets/img/faces/icon.jpg') }}"><span
        ...
        <ul class="side-menu">
            ...
            @can('الفواتير')
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        ...
                        @can('الفواتير المدفوعة')
                            <li><a class="slide-item" href="{{ url('/' . ($page = 'invoice_partial_paid')) }}">الفواتير
                                    المدفوعة
                                    جزئيا</a>
                            </li>
                        @endcan
            ...
            @can('التقارير')
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        @can('تقرير الفواتير')
                            <li><a class="slide-item" href="{{ url('' . ($page = 'invoicesReport')) }}">تقارير
                                    الفواتير</a>
                            </li>
                        @endcan
